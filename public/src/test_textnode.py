...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_node_to_html_node(self):
        ...
        self.assertEqual(TextNode.text_node_to_html_node(boldNode), boldHtmlNode)

        # Test for italic
        italicNode = TextNode("This is italic", "italic")
        italicHtmlNode = LeafNode(tag="i", value="This is italic")
        self.assertEqual(TextNode.text_node_to_html_node(italicNode), italicHtmlNode)

        # Test for code
        codeNode = TextNode("print('Hello')", "code")
        codeHtmlNode = LeafNode(tag="i", value="print('Hello')")
        self.assertEqual(TextNode.text_node_to_html_node(codeNode), codeHtmlNode)
        ...
        self.assertEqual(TextNode.text_node_to_html_node(linkNode), linkHtmlNode)
        ...
        self.assertEqual(TextNode.text_node_to_html_node(imageNode), imageHtmlNode)

        # Test for plain text
        textNode = TextNode("Just plain text", "text")
        textHtmlNode = LeafNode(value="Just plain text")
        self.assertEqual(TextNode.text_node_to_html_node(textNode), textHtmlNode)

        # Test for invalid text type
        invalidNode = TextNode("Invalid", "invalid_type")
        with self.assertRaises(ValueError):
            TextNode.text_node_to_html_node(invalidNode)
